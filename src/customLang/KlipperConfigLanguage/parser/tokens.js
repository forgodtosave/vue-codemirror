...
import { newline as newlineToken, eof, blankLineStart, indent, dedent } from './klipperConfigParser.terms'
...
export const trackIndent = new ContextTracker({
  ...
  shift(context, term, stack, input) {
    ...
    if (term == 100 || term == 100 || term == 100) return new IndentLevel(context, -1)
    return context
  },
  hash(context) {
    return context.hash
